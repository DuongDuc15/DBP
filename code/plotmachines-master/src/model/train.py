...
if __name__ == "__main__":
    ...
    parser.add_argument('--n_embd', type=int, default=74)
    ...
    parser.add_argument('--min_len', type=int, default=5, help='minimum generation length')
    ...
    parser.add_argument('--memstatesize', type=int, default=50, help='size of global document state portion of memory (default:100)')
    ...
    ###### Change: n_ctx(102), gen_len(922), min_len(100), n_embd(1024)
