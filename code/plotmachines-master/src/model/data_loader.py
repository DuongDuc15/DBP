...
class ParagraphDataset(Dataset):
    def __init__(self, data_file, encoder, max_size=None, n_ctx=22, n_gen=52, include_neigh=False,
...
'''
def get_paragraph_input_loader(data_file, batch_size, encoder, shuffle=True, num_workers=0, max_size=None, n_ctx=22,
                               gen_len=52, include_neigh=False, include_discourse_type=True, include_kw=True,
...
class FullStoryDataset(Dataset):
    def __init__(self, data_file, encoder, max_size=None, n_ctx=22, n_gen=52, include_kw=True):
        self.data = []
...
include_kw: unused, if I want to ignore the context
'''
def get_fullstory_loader(data_file, batch_size, encoder, shuffle=True, num_workers=0, max_size=None, n_ctx=22,
                             gen_len=52, include_kw=True):
...
class ParagraphWithMemoryDataset(Dataset):
    def __init__(self, data_file, encoder, max_size=None, n_ctx=22, n_gen=52, include_discourse_type=True,
...
def get_paragraph_memory_input_loader(data_file, batch_size, encoder, shuffle=True, num_workers=0, max_size=None,
                                       n_ctx=22, gen_len=52, include_neigh=False, include_discourse_type=True,
                                       include_kw=True, memsize=10, dim=768, use_kwmem=False, debug_mode=False):
