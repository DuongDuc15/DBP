...
class GPT2BaseModel(nn.Module):
    ...
    '''
    def __init__(self, cfg, vocab=40990, n_ctx=22, gen_len=52, return_probs=False, includeprev=False, lastidx=0,use_offline_gpt2=False ):
    ...
    *args: tuple of model inputs
    ...
    '''
    def forward(self, *args, text_encoder=None, device=None, beam=0, gen_len=52, k=0, p=0, decoding_strategy=0, log=False, generate=False, min_len=None, returnlast=False, returnnewmem=False):
        if generate:
    ...
    def sample(self, *args, classify_idx=0, text_encoder=None, gen_len=52, k=0, p=0, decoding_strategy=0, min_len=None, eos_idx=None):
    ...
    def generate(self, *args, text_encoder=None, device=None, beam=0, gen_len=52, k=0, p=0, decoding_strategy=0, min_len=None):
        ##print(len(args))
        if len(args) == 5:
...
class PlotMachinesModel(nn.Module):
    ...
    *args: tuple of model inputs
    ...
    def sample(self, *args, classify_idx=None, text_encoder=None, gen_len=52, k=0, p=0, decoding_strategy=0, min_len=None, eos_idx=None, returnnewmem = False):
    ...
    *args are expected to be in this format:
    ...
    '''
    def generate(self, *args, text_encoder=None, device=None, beam=0, gen_len=52, k=0, p=0, decoding_strategy=0, min_len=None, returnnewmem=False):
